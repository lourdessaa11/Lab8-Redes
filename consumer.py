...
# Listas para almacenar datos (usamos deque para limitar tamaño)
MAX_POINTS = 50  # Mostrar últimos 50 puntos
...
fig.suptitle('Estación Meteorológica - Datos en Tiempo Real', fontsize=16)


def procesar_mensaje():
    """Lee un mensaje de Kafka si está disponible"""
    try:
        # Timeout corto para no bloquear la animación
        ...
        for tp, messages in msg_pack.items():
            for message in messages:
                ...
                print(f"Dato recibido - Temp: {dato['temperatura']}°C, "
